...
_METRICS = ('campaign.target_cpa.target_cpa_micros',
            'campaign_budget.amount_micros',
            'campaign.target_roas.target_roas', 'campaign.manual_cpm',
            'campaign.manual_cpv',
            ...
            'ad_group.percent_cpc_bid_micros', 'ad_group.target_cpa_micros',
            'ad_group.target_cpm_micros', 'ad_group.target_roas',
            'campaign.optimization_score', 'customer.optimization_score')
