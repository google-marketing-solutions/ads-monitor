...
@pytest.mark.parametrize('customizer_1,customizer_2,expected', [
    (Customizer(CustomizerTypeEnum.INDEX,
                '0'), Customizer(CustomizerTypeEnum.INDEX, '0'), True),
    (Customizer(CustomizerTypeEnum.INDEX,
                '1'), Customizer(CustomizerTypeEnum.INDEX, '0'), False),
    (Customizer(CustomizerTypeEnum.NESTED_RESOURCE,
                '0'), Customizer(CustomizerTypeEnum.INDEX, '0'), False),
    (Customizer(CustomizerTypeEnum.INDEX, '0'),
     Customizer(CustomizerTypeEnum.NESTED_RESOURCE, 'target_cpa_micros'), False)
])
...
@pytest.mark.parametrize(
    ...
    [(Field(name='clicks / impressions',
     ...
     (Field(name='impressions/clicks',
            alias='ctr'), Field(name='clicks/impressions', alias='ctr'), False),
     (Field(
         name='conversions',
         alias='ctr',
